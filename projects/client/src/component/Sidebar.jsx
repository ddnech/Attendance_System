      ...
      <div className="flex flex-col items-center">
        ...
        {routes.map(({ to, icon: Icon, label }, idx) => (
          <Link
            key={idx}
            to={to}
            className="flex w-28 h-14 bg-white items-center cursor-pointer my-4 p-3 rounded-lg transition duration-300 hover:bg-gray-100 hover:border-black hover:border-2"
          >
            <div className="border-2 border-gray-200 w-8 h-8 flex items-center justify-center rounded-full">
              <Icon size={20} />
            </div>
