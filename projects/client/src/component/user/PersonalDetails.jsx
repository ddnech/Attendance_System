      ...
      <div className="max-w-md bg-white shadow-md rounded-lg p-6">
        ...
        <div className="text-left">
          ...
          <p>
            ...
            {dayjs(userProfile.birth_date).format("DD MMMM YYYY")}
          </p>
          <p>
            <strong>Join Date:</strong>{" "}
            {dayjs(userProfile.join_date).format("DD MMMM YYYY")}
          </p>
          <p>
            <strong>Basic Salary:</strong>{" "}
            {userProfile.Salary
              ? `RP ${userProfile.Salary.basic_salary.toLocaleString("id-ID")}`
              : "N/A"}
          </p>
        </div>
      </div>
