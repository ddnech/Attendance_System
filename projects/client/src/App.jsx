  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/clock"
          element={userRole === 2 ? <Profile /> : <Navigate to="/home" />}
        />
        <Route
          path="/payroll-history"
          element={userRole === 2 ? <PayrollPage /> : <Navigate to="/home" />}
        />
        <Route
          path="/attendance-history"
          element={
            userRole === 2 ? <AttendancePage /> : <Navigate to="/home" />
          }
        />
        <Route
          path="/register"
          element={
            userRole === 1 ? <StaffRegisterPage /> : <Navigate to="/home" />
          }
        />
